...
@REM -----------------
@REM   MINDUNIT_OPTS - parameters passed to the Java VM running the mind compiler
...
echo %~dp0\jar_launcher.bat %LAUNCHER% %MINDUNIT_OPTS% -Dmindunit.launcher.name=mindunit  %LAUNCHER% %*
%~dp0\jar_launcher.bat %LAUNCHER% %MINDUNIT_OPTS% -Dmindunit.launcher.name=mindunit  %LAUNCHER% %*
